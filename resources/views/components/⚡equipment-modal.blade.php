...
new class extends Component {
    ...
    protected function rules(): array
    {
        return [
            ...
            'tag_id'          => 'required|string|max:100|unique:equipment,tag_id,' . ($this->equipmentId ?? 'NULL'),
    ...
    public function save(): void
    {
        ...
        session()->flash('message', $this->equipmentId ? 'Equipment updated.' : 'Equipment added.');
...
<div>
    @if($show)
        <div class="fixed inset-0 z-50 flex items-center justify-center">
            {{-- Backdrop --}}
            <div class="absolute inset-0 bg-black/40 backdrop-blur-sm" wire:click="$set('show', false)"></div>
            ...
            <div class="relative bg-white rounded-xl shadow-xl w-full max-w-lg mx-4 p-6 z-10">
                ...
                <div class="flex justify-end space-x-3 mt-6">
                    ...
                    <button wire:click="save" wire:loading.attr="disabled"
                        ...
                        <span wire:loading.remove wire:target="save">{{ $equipmentId ? 'Save Changes' : 'Add Equipment' }}</span>
