    ...
    <aside class="w-64 bg-surface-900 text-slate-300 flex-col hidden md:flex transition-all duration-300">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            <a href="{{ route('admin.dashboard') }}"
               class="block px-4 py-2 bg-primary-900 text-white rounded-md font-medium" wire:navigate>Dashboard</a>
            <a href="{{ route('admin.dashboard') /*route('admin.equipment')*/ }}"
               class="block px-4 py-2 hover:bg-slate-800 hover:text-white rounded-md transition-colors" wire:navigate>Equipment</a>
            <a href="#" class="block px-4 py-2 hover:bg-slate-800 hover:text-white rounded-md transition-colors">Requests</a>
        </nav>
    </aside>
